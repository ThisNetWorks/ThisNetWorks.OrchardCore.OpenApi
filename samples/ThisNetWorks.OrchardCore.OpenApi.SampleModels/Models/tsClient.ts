...
export class SamplePartDto extends ContentPartDto implements ISamplePartDto {
    myTextField?: TextFieldDto | undefined;
    show?: boolean;
    ...
    init(_data?: any) {
        super.init(_data);
        if (_data) {
            this.myTextField = _data["MyTextField"] ? TextFieldDto.fromJS(_data["MyTextField"]) : <any>undefined;
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["MyTextField"] = this.myTextField ? this.myTextField.toJSON() : <any>undefined;
        data["Show"] = this.show;
        super.toJSON(data);
        return data; 
    }
