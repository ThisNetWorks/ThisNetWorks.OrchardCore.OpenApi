...
namespace ThisNetWorks.OrchardCore.OpenApi.SampleModels.Models
{
    ...
    {
        [Newtonsoft.Json.JsonProperty("MyTextField", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public TextFieldDto MyTextField { get; set; }
